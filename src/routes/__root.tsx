  ...
  beforeLoad: async ({ context, location }) => {
    ...
    try {
      ...
      if (persistedState.settings) {
        console.log('ROOT beforeLoad: Restoring settings:', persistedState.settings)
      ...
      context.store.dispatch(setUserState({ user, affiliations }))
      context.store.dispatch(sessionLogin({ userRut: user.userRut, selectedAffiliationId: currentAffiliationId }))

      console.log('ROOT beforeLoad: Session restored successfully for user:', user.userRut)
    } catch (error) {
