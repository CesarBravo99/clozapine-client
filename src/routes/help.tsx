...
export const Route = createFileRoute('/help')({
	...
	loader: async ({ context }) => {
		...
		const help = await getHelpOverview(
			session?.userRut ?? null,
					...
					<CardContent>
						...
						>
							...
							<TabsContent value='patient' className='space-y-4'>
								<div
									className={`p-4 rounded-lg text-sm ${tabItems[0].bannerClass}`}
								>
							...
							<TabsContent value='staff' className='space-y-4'>
								<div
									className={`p-4 rounded-lg text-sm ${tabItems[1].bannerClass}`}
								>
							...
							<TabsContent value='developer' className='space-y-4'>
								<div
									className={`p-4 rounded-lg text-sm ${tabItems[2].bannerClass}`}
								>
