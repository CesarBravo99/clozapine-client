...
function Input({ className, type, ...props }: ComponentProps<'input'>) {
  return (
    <input
      ...
      data-slot="input"
      className={cn(
        'relative file:text-foreground placeholder:text-muted-foreground selection:bg-primary selection:text-primary-foreground',
        'dark:bg-input/30 border-input flex h-10 w-full min-w-0 rounded-md border bg-transparent px-3 py-1',
