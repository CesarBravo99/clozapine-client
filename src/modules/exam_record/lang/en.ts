...
export const en: ExamRecordTranslations = {
	page: {
		...
		subtitle: 'Complete the form before your appointment so the medical team can review your status.',
		successMessage: 'Form submitted successfully. Your medical team will review the information shortly.',
	},
	sections: {
	...
	alerts: {
		submitWarning: 'Please review your data before submitting. You will not be able to edit it afterwards.',
	},
	buttons: {
		submit: 'Send form',
		submitting: 'Sending...',
