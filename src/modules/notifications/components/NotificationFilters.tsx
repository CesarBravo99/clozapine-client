...
export function NotificationFilters({
  ...
  return (
    <div className="mb-4">
      <Button variant="outline" onClick={onToggleFilters} className="w-full justify-between mb-3">
      ...
      <Collapsible open={showFilters}>
        <CollapsibleContent className="space-y-4">
            ...
            <div>
              ...
              <Select value={selectedType} onValueChange={setSelectedType}>
                <SelectTrigger id="type-filter" className="mt-1">
                  <SelectValue
                    placeholder={langs[lang].components.notificationFilters.selectType}
                  />
                </SelectTrigger>
                <SelectContent>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="flex items-center space-x-2">
              <Switch id="rut-toggle" checked={filterByRut} onCheckedChange={setFilterByRut} />
