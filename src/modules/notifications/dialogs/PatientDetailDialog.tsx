                      ...
                      <span>
                        {notification.metadata.completedAt
                          ? dictionary.completedAt.replace(
                              '{date}',
                              new Date(notification.metadata.completedAt).toLocaleDateString(
                                lang === 'es' ? 'es-ES' : 'en-US'
                              )
                            )
