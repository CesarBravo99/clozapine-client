...
export function AffiliationSettings() {
  ...
  const { affiliationSettings, updateAffiliationSettings, persistAffiliationSettings } =
    useConfigContext()
        ...
        <div className="p-4 space-y-4">
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={(event) => updateAffiliationSettings({ hospitalName: event.target.value })}
            />
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <Input
                ...
                onChange={(event) => updateAffiliationSettings({ address: event.target.value })}
              />
            </div>
          </div>
