    ...
    () => [
      columnHelper.accessor('name', {
        ...
        cell: ({ getValue }) => {
          ...
          return <div className="font-medium text-gray-900 dark:text-gray-100">{name}</div>
        },
        filterFn: 'fuzzy',
      }),
      ...
      columnHelper.accessor('lastControl', {
        ...
        cell: ({ getValue }) => {
          ...
          return (
            <div className="text-sm text-gray-600 dark:text-gray-400">{lastControl || '-'}</div>
          )
        },
      ...
      <div className="flex flex-wrap items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-4 text-sm text-gray-600 dark:text-gray-400">
          <span>
            ...
            {langs[lang].components.patientsTable.of} <strong>{table.getPageCount()}</strong>
          </span>
          <span>
