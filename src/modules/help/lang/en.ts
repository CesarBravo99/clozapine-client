...
export const en: HelpModuleTranslations = {
	...
	components: {
		...
		banners: {
			patient: 'Use this form to contact your hospital about treatment doubts or urgent medical questions.',
			staff: 'Reach the hospital administrators about account access and permissions.',
			developer: 'Report bugs, request new features, or send technical feedback to the development team.',
		},
		forms: {
			name: 'Full name',
			rut: 'RUT',
