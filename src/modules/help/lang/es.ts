...
export const es: HelpModuleTranslations = {
	...
	components: {
		...
		banners: {
			patient: 'Use este formulario para contactar a su hospital por dudas de tratamiento o urgencias.',
			staff: 'Comuníquese con los administradores de su hospital sobre accesos y permisos.',
			developer: 'Reporte errores, solicite nuevas funciones o entregue feedback técnico al equipo.',
		},
		forms: {
