  ...
  return (
    ...
    >
      <div className="space-y-4">
        <h4 className="text-md font-semibold text-gray-800 dark:text-white">Cambiar Contraseña</h4>
      ...
      {changePasswordMutation.isSuccess && (
        <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-4">
          <p className="text-green-700 dark:text-green-400">Contraseña cambiada exitosamente</p>
        </div>
      )}
      ...
      <div className="flex justify-end">
        <form.AppForm>
          <form.SubmitButton
            label={changePasswordMutation.isPending ? 'Cambiando...' : 'Cambiar Contraseña'}
