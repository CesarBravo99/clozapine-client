...
export function EventDetailsDialog() {
  ...
  const { isEventDetailsOpen, setEventDetailsOpen, selectedEvent, updateEventStatus, deleteEvent } =
    useCalendarContext()
      ...
      <DialogContent>
        ...
        <div className="space-y-3">
          ...
          <div className="flex flex-wrap gap-2">
            <Button variant="outline" size="sm" onClick={() => updateEventStatus('confirmed')}>
              Confirmar
            </Button>
