    ...
    () => [
        ...
        cell: ({ getValue, row }) => {
          ...
          return (
            <div className="font-medium text-gray-900 dark:text-gray-100">
              <div>{patientName}</div>
              <div className="text-xs text-gray-500 dark:text-gray-400">RUT: {patientRut}</div>
            </div>
          )
        },
        filterFn: 'fuzzy',
      ...
      columnHelper.accessor('medication', {
        ...
        cell: ({ getValue }) => {
          ...
          return <div className="text-sm text-gray-900 dark:text-gray-100">{medication}</div>
        },
        filterFn: 'fuzzy',
      }),
      ...
      columnHelper.accessor('status', {
        ...
        cell: ({ getValue }) => {
          ...
          let className = 'bg-green-100 text-green-800 dark:bg-green-900/20 dark:text-green-400'
          ...
          const displayStatus = statusLabels[status as keyof typeof statusLabels] || status
      ...
      <div className="flex flex-wrap items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-4 text-sm text-gray-600 dark:text-gray-400">
          <span>
            ...
            {langs[lang].components.prescriptionsTable.of} <strong>{table.getPageCount()}</strong>
          </span>
          <span>
